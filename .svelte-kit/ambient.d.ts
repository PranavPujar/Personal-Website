...
declare module '$env/static/private' {
	...
	export const APPMOD_TELEMETRY_SENDER: string;
	...
	export const APPMOD_HOOK_SCRIPTS_DIR: string;
	export const OPENAI_API_KEY: string;
	export const COMMAND_MODE: string;
	export const npm_config_globalconfig: string;
	export const SDKMAN_CANDIDATES_API: string;
	export const CONDA_EXE: string;
	export const VSCODE_SESSION_ID: string;
	export const SSH_AUTH_SOCK: string;
	export const __CF_USER_TEXT_ENCODING: string;
	export const npm_execpath: string;
	export const VIRTUAL_ENV: string;
	export const APPMOD_NODE: string;
	...
	export const ENABLE_PYTHON_MIGRATION: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		COLOR: string;
		APPMOD_TELEMETRY_SENDER: string;
		...
		USER: string;
		NVM_DIR: string;
		APPMOD_HOOK_SCRIPTS_DIR: string;
		...
		ENABLE_PYTHON_MIGRATION: string;
